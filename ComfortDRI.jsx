...
export default function ComfortDRI(){
  ...
  const sections = [{"title": "Electrical", "rows": [["Supply Voltage", "110\u2013240 VAC (50/60 Hz)"], ["Rated Power", "1.4 kW (nominal)"], ["Standby", "< 1 W"]]}, {"title": "Performance", "rows": [["Dry Time", "~16 s"], ["Air Velocity", "~60 m/s"], ["Airflow", "~90 m\u00b3/h"]]}, {"title": "Acoustic", "rows": [["Sound Pressure", "~67 dBA @ 1 m"], ["Mode", "Single speed"]]}, {"title": "Thermal", "rows": [["Outlet Temperature", "~38 \u00b0C (ambient dependent)"]]}, {"title": "Materials & Finish", "rows": [["Housing", "ABS / Polycarbonate"], ["Finish Options", "Silver | Black | White"]]}, {"title": "Dimensions", "rows": [["W \u00d7 H \u00d7 D", "285 \u00d7 195 \u00d7 110 mm"], ["Weight", "3.4 kg"]]}, {"title": "Compliance", "rows": [["Certifications", "CE, UKCA, ETL (regions)"], ["Warranty", "7 years (registration required)"]]}];
        ...
        <div className='container grid md:grid-cols-3 gap-6 items-start'>
          <div className='md:col-span-2'>
            ...
            <ul className='mt-4 grid md:grid-cols-2 gap-3 list-disc pl-5 text-sm text-gray-700'>
              <li>Heated motor for warm outlet temperature</li><li>Wide aperture for even airflow</li><li>Quiet operation engineered ~67 dBA @ 1 m</li><li>Touch‑free IR activation</li>
            </ul>
          </div>
